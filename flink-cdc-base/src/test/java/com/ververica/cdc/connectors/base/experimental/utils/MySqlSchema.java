...
//
// import static
// com.ververica.cdc.connectors.base.experimental.utils.MySqlConnectionUtils.createMySqlDatabaseSchema;
//
...
//
//    /**
//     * Gets table schema for the given table path. It will request to MySQL server by running
// `SHOW
