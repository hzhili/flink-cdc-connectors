...
//
// import
// com.ververica.cdc.connectors.base.experimental.fetch.MySqlStreamFetchTask.MySqlBinlogSplitReadTask;
...
//
// import static
// com.ververica.cdc.connectors.base.experimental.utils.MySqlConnectionUtils.createMySqlConnection;
// import static
// com.ververica.cdc.connectors.base.experimental.utils.MySqlConnectionUtils.currentBinlogOffset;
// import static
// com.ververica.cdc.connectors.base.experimental.utils.MySqlUtils.buildSplitScanQuery;
// import static
// com.ververica.cdc.connectors.base.experimental.utils.MySqlUtils.readTableSplitDataStatement;
//
...
//         */
//        private Object readField(ResultSet rs, int fieldNo, Column actualColumn, Table
// actualTable)
//                throws SQLException {
...
//            // by reading them with a calendar based on the default time zone, we make sure that
// the
//            // value
...
//                // inserted
//                // We thus need to use getObject() to identify if the value was provided and if
// yes
//                // then
...
//
//        /**
//         * In non-string mode the date field can contain zero in any of the date part which we
// need
...
//
//        /**
//         * In non-string mode the time field can contain zero in any of the date part which we
// need
//         * to handle as all-zero.
//         */
...
//
//    /**
//     * The {@link ChangeEventSource.ChangeEventSourceContext} implementation for bounded binlog
// task
