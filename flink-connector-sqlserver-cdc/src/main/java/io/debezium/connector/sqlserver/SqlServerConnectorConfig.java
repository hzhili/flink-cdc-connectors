...
/** The list of configuration options for SQL Server connector. 修改 357行,添加catalog. */
public class SqlServerConnectorConfig extends HistorizedRelationalDatabaseConnectorConfig {
    ...
    public static final Field MAX_RETRIES_ON_ERROR =
            Field.create(ERRORS_MAX_RETRIES)
    ...
    private static class SystemTablesPredicate implements TableFilter {
        ...
        public boolean isIncluded(TableId t) {
            LOGGER.info("table is included {} ?", t);
    ...
    public Map<TableId, String> getSnapshotSelectOverridesByTable() {
        ...
        for (String table : tableValues) {
            snapshotSelectOverridesByTable.put(
                    ...
                    getConfig()
                            .getString(SNAPSHOT_SELECT_STATEMENT_OVERRIDES_BY_TABLE + "." + table));
        }
