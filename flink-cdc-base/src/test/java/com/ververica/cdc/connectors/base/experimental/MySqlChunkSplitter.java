...
//
//    /**
//     * Split table into evenly sized chunks based on the numeric min and max value of split
// column,
...
//            throws SQLException {
//        LOG.info(
//                "Use unevenly-sized chunks for table {}, the chunk size is {}", tableId,
// chunkSize);
//        final List<ChunkRange> splits = new ArrayList<>();
//        Object chunkStart = null;
...
//                    String.format(
//                            "Unsupported operation type, the MIN value type %s is different with
// MAX value type %s.",
...
//        LOG.info(
//                "The distribution factor of table {} is {} according to the min split key {}, max
// split key {} and approximate row count {}",
//                tableId,
//                distributionFactor,
//                min,
//                max,
